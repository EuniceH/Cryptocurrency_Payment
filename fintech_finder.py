...
################################################################################
# EH: Import library and dependencies
...
#EH:  Import all functions from crypto_wallet file
...
#EH:  create dictionary for Fintech Finder candidates
candidate_database = {
...
# EH: A list of the FinTech Finder candidates first names

people = ["Lane", "Ash", "Jo", "Kendall"]

#EH:  function to display Fintech finders candidate information
def get_people(w3):
    """Display the database of Fintech Finders candidate information."""

    #EH: create list to store candidates data
    db_list = list(candidate_database.values())

    #EH: loop through people list to display candidates profile
...
# EH:  Streamlit application headings
st.markdown("# Fintech Finder!")
st.markdown("## Hire A Fintech Professional!")
st.text(" \n")

################################################################################
#EH: Streamlit Sidebar Markdown
...
#EH:  generate sender account
account=generate_account()

##########################################

# EH:  Write the client's Ethereum account address to the sidebar
...
#EH:  get client's ether balance
ether_balance=get_balance(w3,account.address)

#EH: display client's balance on the sidebar 
st.sidebar.write(f'The client balance in ether: {ether_balance}')
##########################################

# EH: Create a select box to chose a FinTech Hire candidate
person = st.sidebar.selectbox('Select a Person', people)

# EH: Create a input field to record the number of hours the candidate worked
hours = st.sidebar.number_input("Number of Hours")

#EH:  write sidebar markdown
st.sidebar.markdown("## Candidate Name, Hourly Rate, and Ethereum Address")

#EH: Identify the FinTech Hire candidate
candidate = candidate_database[person][0]

#EH: Write the Fintech Finder candidate's name to the sidebar
st.sidebar.write(candidate)

#EH: Identify the FinTech Finder candidate's hourly rate
hourly_rate = candidate_database[person][3]

#EH: Write the inTech Finder candidate's hourly rate to the sidebar
st.sidebar.write(hourly_rate)

#EH: Identify the FinTech Finder candidate's Ethereum Address
candidate_address = candidate_database[person][1]

#EH: Write the inTech Finder candidate's Ethereum Address to the sidebar
...
#EH: calculate candidate wage
wage=hourly_rate * hours

# @TODO
# EH: Write the `wage` calculation to the Streamlit sidebar
...
#EH: create send transaction button
if st.sidebar.button("Send Transaction"):
    ...
    #EH: sender's hash transaction record
    transaction_hash=send_transaction(w3,account,candidate_address,wage)

    #EH:  Markdown for the transaction hash
    st.sidebar.markdown("#### Validated Transaction Hash")

    #EH: Write the returned transaction hash to the screen
    st.sidebar.write(transaction_hash)

    #EH: Celebrate successful payment
    st.balloons()

# The function that starts the Streamlit application
#EH: Writes FinTech Finder candidates to the Streamlit page
get_people(w3)
